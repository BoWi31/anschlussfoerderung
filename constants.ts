...
export const STUDENTS_MATHE_ASF = [
  'Samir (5.1)',
  'Hristina (5.1)',
  'Danilo (5.1)',
  'Yevhen (5.1)',
...
export const SCHEDULE: ASFSession[] = [
  ...
  // --- NEU: Mathe-ASF ---
  { id: 'mau-di-12', label: 'Mathe-ASF', teacher: 'Maushake', room: 'W204', day: 2, startTime: '08:00', endTime: '09:30', students: STUDENTS_MATHE_ASF },
  { id: 'dev-mi-12', label: 'Mathe-ASF', teacher: 'De Vries', room: 'W204', day: 3, startTime: '08:00', endTime: '09:30', students: STUDENTS_MATHE_ASF }
];
